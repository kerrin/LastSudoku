...
namespace Sudoku.Solver.Unsolver
{
     ...
     *
    * Value-placing rules (Naked Single, Hidden Single, Right Angle) get dedicated handlers.
     ...
     * New value-placing rules should be registered here when they are added.
     */
