        ...
        private (Cell endpoint1, Cell endpoint2, int digit, List<Cell> removals, List<Cell> witnesses)? FindElimination(Board board)
        {
            ...
            for (int digit = 1; digit <= size; digit++)
            {
                ...
                for (int r = 0; r < size; r++)
                {
                    ...
                    // include rows that have at least two candidates; we'll consider 2-element subsets
                ...
                for (int i = 0; i < rows.Count; i++)
                    for (int j = i + 1; j < rows.Count; j++)
                    {
                        ...
                        foreach (var cols1 in options1)
                            ...
                            {
                                    // allow rows that contain a conjugate pair among other candidates;
                                    // the specific 2-element subsets are generated by GetTwoElementSubsets
            ...
            for (int digit = 1; digit <= size; digit++)
            {
                ...
                for (int c = 0; c < size; c++)
                {
                    ...
                    // include columns that have at least two candidates; we'll consider 2-element subsets
                ...
                for (int i = 0; i < cols.Count; i++)
                    for (int j = i + 1; j < cols.Count; j++)
                    {
                        ...
                        foreach (var rows1 in options1)
                            ...
                            {
                                // allow columns that contain a conjugate pair among other candidates;
                                // the specific 2-element subsets are generated by GetTwoElementSubsets
