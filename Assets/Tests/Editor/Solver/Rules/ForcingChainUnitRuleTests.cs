...
{
    public class ForcingChainUnitRuleTests
    {
        ...
        [Test]
        public void ForcingChainUnitRule_Example1_ContradictionBranch_RemovesAssumptionCandidate()
        {
            var board = TestHelpers.CreateEmptyBoard();
            var rule = new ForcingChainUnitRule();
        ...
        [Test]
        public void ForcingChainUnitRule_Example2_CommonFalseConclusion_RemovesTargetCandidate()
        {
            var board = TestHelpers.CreateEmptyBoard();
            var rule = new ForcingChainUnitRule();
        ...
        [Test]
        public void ForcingChainUnitRule_Example3_CommonTrueConclusion_PlacesValue()
        {
            var board = TestHelpers.CreateEmptyBoard();
            var rule = new ForcingChainUnitRule();
        ...
        [Test]
        public void ForcingChainUnitRule_Example4_ColourPrerequisiteDisabled_DoesNotApply()
        {
            var board = TestHelpers.CreateEmptyBoard();
            var rule = new ForcingChainUnitRule();
